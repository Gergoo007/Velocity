...
import me.gergoo007.velocity.ui.HUD;
...
public class GuiIngame extends Gui
{
    ...
    protected void func_180479_a(ScaledResolution sr, float p_180479_2_)
    {
        if (this.mc.func_175606_aa() instanceof EntityPlayer)
        {
            ...
            */
            ...
            //this.drawTexturedModalRect(var4 - 91 - 1 + var3.inventory.currentItem * 20, p_180479_1_.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            /*
             * Jobb ill. bal sz�le a hotbarnak + a vonal magass�ga mely jelzi melyik item van kivalasztva..
             */
            float x = (float)var4 - 90 + var3.inventory.currentItem * 20;
            float left = 122;
            float height = (float)sr.getScaledHeight_double() - 2;
            
    		this.drawRect(0, sr.getScaledHeight_double() - 22, sr.getScaledWidth_double(), sr.getScaledHeight_double(), 0xad111111);
    		this.drawRect(1, 1, 1, 1, color);
    		//this.drawRect(var4 - 71 + var3.inventory.currentItem * 20, height, var4 - 89 - 1 + var3.inventory.currentItem * 20, sr.getScaledHeight_double(), Rainbow.getRainbow()); // <- hotbar (jelenlegi item alatti szar)
    		RenderingUtils.drawRoundedRect(x, height, x + 20, sr.getScaledHeight(), color, 0.7F);
    		this.zLevel = var5;
            GlStateManager.enableRescaleNormal();
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
