    ...
    protected List call()
    {
        ...
        if (this.func_175236_d())
        {
            return Lists.newArrayList(new String[] {
            		"Minecraft 1.8 (" + "velocity" + "/" + ClientBrandRetriever.getClientModName() + ")", 
            		...
            		new Object[]{Integer.valueOf(var1.getX() & 15), 
        ...
        else
        {
            ...
            ArrayList var5 = Lists.newArrayList(new String[] {
            		...
            		String.format("Block: %d %d %d", new Object[]{Integer.valueOf(var1.getX()), 
            		...
            		Integer.valueOf(var1.getX() >> 4), Integer.valueOf(var1.getY() >> 4), 
            		Integer.valueOf(var1.getZ() >> 4)}), String.format("Facing: %s (%s) (%.1f / %.1f)", 
